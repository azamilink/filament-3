    ...
    <body>
        <div class="bg-[url('https://cdn.pixabay.com/photo/2016/11/14/03/16/book-1822474_1280.jpg')] bg-center bg-cover h-screen">
            ...
            <div class="md:space-x-4 absolute bottom-[80px] left-[50%] translate-x-[-50%]">
                <button class="mt-2 md:mt-0 uppercase bg-slate-200 rounded-full text-gray-900 w-96 h-10 md:w-60"><a href="/admin">Get Started</a></button>
            </div>

            <div class="absolute left-[50%] translate-x-[-50%] bottom-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 animate-bounce" viewBox="0 0 20 20" fill="currentColor">
